else if ($querytype == 'getinvoiceheaders')
{
	...
	*/
	...
	////-echo "</INVOICES>\n";
	//echo "Line: " . $lineamount;
	//echo " GST: " . $linegstamount;
	//echo " Full Total: " . $totallinespayable;

	////-echo "<LINEAMOUNT>" . rawurlencode($lineamount) . "</LINEAMOUNT>\n";
	////-echo "<LINETAXAMOUNT>" . rawurlencode($linegstamount) . "</LINETAXAMOUNT>\n";
	////-echo "<LINETOTALAMOUNT>" . rawurlencode($totallinespayable) . "</LINETOTALAMOUNT>\n";

	////-echo "<TOTALINVOICEPAYABLE>" . rawurlencode($totalinvpayable) . "</TOTALINVOICEPAYABLE>\n";
	////-echo "<TOTALLINESPAYABLE>" . rawurlencode($totallinespayable) . "</TOTALLINESPAYABLE>\n";
	//$row = ibase_fetch_object($results);
	//echo "<TRANSFER_COMPLETE>YES</TRANSFER_COMPLETE>\n";
	////-echo "</xml>\n";
}