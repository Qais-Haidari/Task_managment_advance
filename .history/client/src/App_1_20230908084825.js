  ...
  return (
    <div className="bg-green-600">
      <nav class="flex items-center justify-between flex-wrap bg-blue-600 p-6">
        ...
        <div class="w-full block sm:flex-initial flex-grow lg:flex lg:items-center lg:w-auto">
          <div class="text-sm lg:flex-grow">
            ...
            <Link to="/admin">
              <p class="block mr-2 mt-4 lg:inline-block sm:invisible md:invisible lg:mt-0 text-white hover:text-white mr  -4">
                Admin
              </p>
            </Link>
            <Link to="/dashboard">
