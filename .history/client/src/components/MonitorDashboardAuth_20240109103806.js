        ...
        {unAction.map((r) => (
                <div className="flex mt-3" >
                    ...
                    {r.Attachment === "Yes" ? (
                      ...
                      <p className="text-white text-xl" >Value: {r.Value}</p>
                    )}
                    <p className="text-white text-xl ml-2 " >Submit Date<span className='text-black' >: {r.SubmitDate}</span></p>
                    { r.SubmitDate ? <><p className="text-white text-xl ml-2 " >Submitted<span className='text-black' >: Yes</span></p></> : <><p className="text-white text-xl ml-2 " >Submitted<span className='text-black' >: Yes</span></p></> }
                    <p className="text-white text-xl ml-2 " >Approve By<span className='text-black' >: {r.Approve_By}</span></p>
                    <p className="text-white text-xl ml-2 " >2IC<span className='text-black' >: {r.Approve_By}</span></p>
                    <p className="text-white text-xl ml-2 " >Questions: <span className='text-black' >{r.Questions}</span></p>
