              ...
              <div className="">
                <div className="inline-block min-w-full shadow-md rounded-lg overflow-hidden">
                  <table className="min-w-full leading-normal">
                    <thead>
                      <tr>
                        <th className="px-5 py-3 sm:block lg:block border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 capitalize tracking-wider">
                          Priority
                        </th>
                    ...
                    <tbody>
                      <tr>
                        <td className="px-5 sm:block lg:block py-2 border-b border-gray-200 bg-white text-sm">
