              ...
              >
                ...
                <div className="flex space-x-4 ml-5">
                  ...
                  {r.Assign_to_Department === "" ? (
                    ...
                    <h4 className="mt-3 text-white text-md font-medium">
                      Escalated to Department: <span className=" font-normal"></span>{r.Assign_to_Department}</span>
                    </h4>
                  )}
                  {r.Escalated_to_User === "" ? (
                    <></>
                    ...
                    <h4 className="mt-3 text-white text-md font-medium">
                      Escalated to User: <span className=" font-normal"></span>{r.Escalated_to_User}</span>
                    </h4>
                  )}
                  {r.Escalated_to_Department === "" ? (
                    <></>
                    ...
                    <h4 className="mt-3 text-white text-md font-medium">
                      Escalated to Department: <span className=" font-normal"></span>{r.Escalated_to_Department}</span>
                    </h4>
                  )}
                  <h4 className="mt-3 text-white text-md font-medium">
                      Submitted: Yes
