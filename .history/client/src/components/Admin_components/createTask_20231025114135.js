...
export default function Admin() {
  ...
  const [Type__, setType_] = useState("");
  const [Min__, setMin_] = useState("");
  const [Max__, setMax_] = useState("");
  const [Expected__, setExpected_] = useState("");
  const [Question__, setQuestion_] = useState("");
