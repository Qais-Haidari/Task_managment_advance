...
import User from "../AdvanceDashboard/User";
import EXUser from "../AdvanceDashboard/EXUser";
import Department from "../AdvanceDashboard/Department";
import EXDepartment from "../AdvanceDashboard/EXDepartment";
...
export default function Tasklist() {
  ...
  return (
    <>
      ...
      <ExUser Department={Department} />
      <EXDepartment EXUser={ExUser}
        EXDepartment={EXDepartment} />
    </>
  );
}
