...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://10.0.0.116:5000/User/one/${id}`)
      .then((res) => {
  ...
  const post = () => {
    axios
      .post(`http://10.0.0.116:5000/CreateUser/update/${ID}`, {
        First_Name: First,
        Last_Name: Last,
        Email: Email,
        Phone: Phone,
        ...
        <div class="py-5">
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="w-full md:w-1/2 px-3">
              ...
              <select onClick={(e) => setIC(e.target.value)} className="appearance-none block w-full  text-gray-700 border border-gray-200 rounded py-2 px-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" >
                {state.map((r) => (
