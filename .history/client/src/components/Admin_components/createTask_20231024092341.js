...
export default function Admin() {
  ...
  const More_ = () => {
    MoreReq.push([
      document.getElementById('Type').valueOf()
      document.getElementById('Min').valueOf()
      document.getElementById('Max').valueOf()
      document.getElementById('Expected').valueOf()
      document.getElementById('Questions').valueOf()
    ]);
