...
export default function Admin() {
  ...
  const [Type__, setType__] = useState("");
  const [Min__, setMin__] = useState("");
  const [Max__, setMax__] = useState("");
  const [Expected__, setExpected__] = useState("");
  const [Question__, setQuestion__] = useState("");
