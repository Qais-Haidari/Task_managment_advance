                      ...
                      <div>
                        {MoreReqs.map((r) => (
                          <div className="flex flex-row">
                            <p className="text-red-600" >Type: <span>{r[0].Type}</p>
                            <p className="text-red-600" >Min: <span>{r[0].Min}</p>
                            <p className="text-red-600" >Max: <span>{r[0].Max}</p>
                            <p className="text-red-600" >Expected: <span>{r[0].Expected}</p>
                            <p className="text-red-600" >Question: <span>{r[0].Question}</p>
                          </div>
                        ))}
                      </div>
                    </div>
