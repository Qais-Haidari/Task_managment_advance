                    ...
                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 w-full">
                      <div className="flex flex-wrap px-3 mt-2 shadow-xl rounded pb-2">
                        ...
                        <div className="mr-2">
                          <button
                            type="button"
                            className=" mt- inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto"
                            onClick={More_}
                          >
                            Add
                          </button>
