...
export default function Admin() {
  ...
  const More_ = () => {
    MoreReq.push([
      document.getElementById('Type').va
      document.getElementById('Min').va
      document.getElementById('Max').va
      document.getElementById('Expected').va
      document.getElementById('Questions').va
    ]);
