...
export default function Admin() {
  ...
  const Type___ = (e) => setType_(e.target.value);
  const Min___ = (e) => setMin_(e.target.value);
  const Max___ = (e) => setMax_(e.target.value);
  const Expected___ = (e) => setExpected_(e.target.value);
  const Question___ = (e) => setQuestion_(e.target.value);
  useEffect(() => {
    axios
