                      ...
                      <div>
                        {MoreReqs.map((r) => (
                          <div className="flex flex-row">
                            <p className="text-red-600" >Type: < className= span>{r[0].Type}</span></p>
                            <p className="text-red-600" >Min: < className= span>{r[0].Min}</span></p>
                            <p className="text-red-600" >Max: < className= span>{r[0].Max}</span></p>
                            <p className="text-red-600" >Expected: < className= span>{r[0].Expected}</span></p>
                            <p className="text-red-600" >Question: < className= span>{r[0].Question}</span></p>
                          </div>
                        ))}
                      </div>
                    </div>
