...
import ScrrUser from "../AdvanceDashboard/User";
import ScrrEXUser from "../AdvanceDashboard/EXUser";
import ScrrDepartment from "../AdvanceDashboard/Department";
import ScrrEXDepartment from "../AdvanceDashboard/EXDepartment";
...
export default function Tasklist() {
  ...
  return (
    <>
      ...
      <ExUser EXUser={ExUser} />
      <EXDepartment EXDepartment={EXDepartment} />
    </>
  );
}
