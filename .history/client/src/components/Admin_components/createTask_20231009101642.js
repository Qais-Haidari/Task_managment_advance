...
export default function Admin() {
  ...
  const post = () => {
    if (
      ...
      !start_date_time ||
      !Question ||
      Priority === "Please Select User Who Approve This Task" ||
      !Type
    ) {
      setOpen(true);
    } else {
      ...
      <div>
        ...
        <div className="flex">
          <div className="mx-8 flex-1">
            ...
            <div className="w-full flex flex-wrap px-3 mt-2 shadow-xl rounded pb-2">
              <div className="mr-2">
                    ...
                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                      <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                          ...
                          <div className="mt-2">
                            {!Short_description ? (
                              <p className="text-sm text-gray-500">Short Desc</p>
                            ) : (
                              <p className="text-sm text-gray-500"></p>
                            )}
                            Summary Priority start_date_time Question Priority
                            Type
                          </div>
                        </div>
                      </div>
