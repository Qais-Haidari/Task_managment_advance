                      ...
                      <div>
                        {MoreReqs.map((r) => (
                          <div className="flex flex-row">
                            <p className="text-red-600" >Type: {r[0].Type}</p>
                            <p className="text-red-600" >Min: {r[0].Min}</p>
                            <p className="text-red-600" >Max: {r[0].Max}</p>
                            <p className="text-red-600" >Expected: {r[0].Expected}</p>
                            <p className="text-red-600" >Question: {r[0].Question}</p>
                          </div>
                        ))}
                      </div>
                    </div>
