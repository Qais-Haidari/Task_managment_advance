...
export default function Admin() {
  ...
  const Assign_to_User_ = (e) => {
    if (e.target.value) {
      ...
      axios
        .get(`http://10.0.0.112:5000/Users/${e.target.value}`)
        .then((res) => {
  ...
  const Assign_to_Department_ = (e) => {
    if (e.target.value) {
      axios
        .get(`http://10.0.0.112:5000/tasks2/${e.target.value}`)
        .then((res) => {
          setUserAuth(res.data);
        })
        .catch((err) => (document.body.innerHTML = err));
  ...
  const Escalated_to_User_ = (e) => {
    if (e.target.value) {
      axios
        .get(`http://10.0.0.112:5000/tasks3/${e.target.value}`)
        .then((res) => {
          setUserAuth(res.data);
        })
        .catch((err) => (document.body.innerHTML = err));
  ...
  const Escalated_to_Department_ = (e) => {
    if (e.target.value) {
      axios
        .get(`http://10.0.0.112:5000/tasks4/${e.target.value}`)
        .then((res) => {
          setUserAuth(res.data);
        })
        .catch((err) => (document.body.innerHTML = err));
  ...
  const post = () => {
    if (
      ...
      axios
        .post("http://10.0.0.112:5000/createTask", {
          OnceOFF: onceOFF,
        ...
        <div className="flex">
          <div className="mx-8 flex-1">
            ...
            <div className="flex flex-wrap px-3 mt-2 shadow-xl rounded pb-2">
              ...
              {Type === "Attachement" ? <></> : (<div className="mr-2">
