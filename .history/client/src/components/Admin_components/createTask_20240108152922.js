          ...
          <div className="mx-8 flex-1">
            ...
            <div className="flex flex-wrap px-3 mt-2 shadow-xl rounded pb-2">
              ...
              {Type === "Attachement" ? (
                <>
                <div className="mr-2">
                    <p className="mb-2">Trusted Image</p>
                    <input
                      className="shadow appearance-none w-28 border rounded  py-2 px-3 text-gray-700 4 focus:outline-none focus:shadow-outline"
                      id="Min"
                      type="file"
                      onChange={Min_}
                    />
