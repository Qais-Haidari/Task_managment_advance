...
export default function Admin() {
  ...
  const Type___ = (e) => setType(e.target.value);
  const Min___ = (e) => setMin(e.target.value);
  const Max___ = (e) => setMax(e.target.value);
  const Expected___ = (e) => setExpected(e.target.value);
  const Question___ = (e) => setQuestion(e.target.value);
  useEffect(() => {
    axios
