...
export default function Tasklist({ EXDepartment }) {
  ...
  useEffect(() => {
    axios
      .get(
        `http://10.0.0.116:5000/task/advancedashboard/EXDepartment/${MomentDate()}/${EXDepartment}/${getCurrentTimeDashboard()}`
      )
      .then((res) => {
        setstate(res.data);
        let state = res.data;
        ...
        axios
          .post(
            `http://10.0.0.116:5000/task/advancedasbhboard/TaskID/${MomentDate()}/${
              EXDepartment[0].Name
            }`,
  ...
  return (
    <>
      <table class="table-auto w-full">
        <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-900">
          <tr>
            <th class="p-2 whitespace-nowrap">
              <div class="font-semibold text-left">Es Department</div>
            </th>
            <th class="p-2 whitespace-nowrap">
        ...
        <tbody class="text-sm divide-y divide-gray-100 h-full">
          <tr>
            <td class="p-2 whitespace-nowrap">
              <div class="">
                <div class="text-lg text-left ">{EXDepartment}</div>
              </div>
            </td>
            <td class="p-2 whitespace-nowrap">
