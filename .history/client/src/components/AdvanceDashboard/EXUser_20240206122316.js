...
export default function Tasklist({ ExUser }) {
  ...
  useEffect(() => {
    axios
      .get(
        `http://10.0.0.116:5000/task/advancedashboard/EXUser/${MomentDate()}/${
          ExUser[0].Name
        }/${getCurrentTimeDashboard()}`
      )
      .then((res) => {
        setstate(res.data);
        let state = res.data;
        ...
        axios
          .post(
            `http://10.0.0.116:5000/task/advancedasbhboard/TaskID/${MomentDate()}/${ExUser}`,
        ...
        <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-900">
          <tr>
            <th class="p-2 whitespace-nowrap">
              <div class="font-semibold text-left">Es User</div>
            </th>
            <th class="p-2 whitespace-nowrap">
        ...
        <tbody class="text-sm divide-y divide-gray-100 h-full">
          <tr>
            <td class="p-2 whitespace-nowrap">
              <div class="">
                <div class="text-lg text-left ">{ExUser}</div>
              </div>
            </td>
            <td class="p-2 whitespace-nowrap">
