...
export default function User({ User }) {
  ...
  useEffect(() => {
    axios
      .get(
        `http://10.0.0.112:5000/task/advancedashboard/User/${MomentDate()}/${
          User[0].Name
        }`
      )
      .then((res) => {
  ...
  return (
    <>
      <table class="table-auto w-full">
        <thead class="text-xs font-semibold uppercase sticky text-gray-400 bg-gray-50">
          <tr>
        ...
        <tbody class="text-sm divide-y divide-gray-100 h-full">
          <tr>
            <td class="p-2 whitespace-nowrap">
              <div class="">
                <div class="text-lg text-left ">{User[0].Name}</div>
              </div>
            </td>
            <td class="p-2 whitespace-nowrap">
