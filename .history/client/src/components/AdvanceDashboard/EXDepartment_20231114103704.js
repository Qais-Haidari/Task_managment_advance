...
export default function Tasklist({ EXDepartment }) {
  ...
  useEffect(() => {
    axios
      .get(
        `http://10.0.0.112:5000/task/advancedashboard/EXDepartment/${MomentDate()}/${
          EXDepartment[0].Name
      ...
      .then((res) => {
        ...
        axios
          .post(
            `http://10.0.0.112:5000/task/advancedasbhboard/TaskID/${MomentDate()}/${
              EXDepartment[0].Name
            }`,
        ...
        <tbody class="text-sm divide-y divide-gray-100 h-full">
          <tr>
            <td class="p-2 whitespace-nowrap">
              <div class="">
                <div class="text-lg text-left ">{EXDepartment[0].Name}</div>
              </div>
            </td>
            <td class="p-2 whitespace-nowrap">
