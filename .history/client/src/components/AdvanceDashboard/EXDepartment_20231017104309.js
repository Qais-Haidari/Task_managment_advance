...
export default function Tasklist({ EXDepartment }) {
  ...
  useEffect(() => {
    axios
      .get(
        `http://localhost:5000/task/advancedashboard/EXDepartment/${MomentDate()}/${
          EXDepartment[0].Name
        ...
        <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
          <tr>
            <th class="p-2 whitespace-nowrap">
              <div class="font-semibold text-center">Es Department</div>
            </th>
            <th class="p-2 whitespace-nowrap">
        ...
        <tbody class="text-sm divide-y divide-gray-100 h-full">
          <tr>
            <td class="p-2 whitespace-nowrap">
              <div class="">
                <div class="text-lg text-center ">{EXDepartment[0].Name}</div>
              </div>
            </td>
            <td class="p-2 whitespace-nowrap">
