...
export default function BulkUpdate() {
  ...
  useEffect(() => {
    axios
      .get(`http://10.0.0.116:5000/task_`)
      .then((res) => {
        setstate(res.data);
      })
  ...
  const Update = () => {
    ...
    axios
      .post(`http://10.0.0.116:5000/BuldUpdate`, {
        IDs: arr,
      ...
      <div className="mx-8">
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              className=" block w-full bg-gray-200  border rounded py-2 px-2 mb-3 4 focus:outline-none focus:bg-white"
              id="grid-first-name"
          ...
          <div className="w-full md:w-1/2 px-3">
            ...
            <input
              className="appearance-none block w-full bg-gray-200  border border-gray-200 rounded py-2 px-2 4 focus:outline-none focus:bg-white focus:border-gray-500"
              id="grid-last-name"
              onChange={Summary_}
              type="text"
            />
          ...
          <div className="w-full md:w-1/2 px-3">
            <select
              className="mb-2 block appearance-none w-full bg-gray-200 border border-gray-200  py-2 px-2 pr-8 rounded 4 focus:outline-none focus:bg-white focus:border-gray-500"
              id="grid-state"
            ...
            <div>
              <select
                className="block appearance-none w-full bg-gray-200 border border-gray-200  py-2 px-2 pr-8 rounded 4 focus:outline-none focus:bg-white focus:border-gray-500"
                id="grid-state"
        ...
        <div class="">
          <div class="inline-block min-w-full shadow-md rounded-lg overflow-hidden">
            <table class="min-w-full leading-normal">
              <thead>
                <tr>
                  <th class="px-5 py-3 border-b-2 border-gray-200  text-left text-md font-semibold text-white bg-gray-900 capitalize tracking-wider"></th>
                  <th class="px-5 py-3 border-b-2 border-gray-200  text-left text-md font-semibold text-white bg-gray-900 capitalize tracking-wider">
                    description
                  </th>
                  <th class="px-5 py-3 border-b-2 border-gray-200  text-left text-md font-semibold text-white bg-gray-900 capitalize tracking-wider">
                    Summary
