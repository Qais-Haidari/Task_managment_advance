...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://10.0.0.116:5000/PrimaryTasks`)
      .then((res) => {
        setstate(res.data);
      })
    ...
    axios
      .get(
        `http://10.0.0.116:5000/PrimaryTasks/user/${localStorage.getItem(
          "First_Name"
        )}`
      )
      .then((res) => {
  ...
  const User_ = (e) => {
    axios
      .get(`http://10.0.0.116:5000/PrimaryTasks/user/${e.target.value}`)
      .then((res) => {
        setstate(res.data);
      })
      .catch((err) => (document.body.innerHTML = err));
  ...
  const Department_ = (e) => {
    axios
      .get(`http://10.0.0.116:5000/PrimaryTasks/department/${e.target.value}`)
      .then((res) => {
        setstate(res.data);
      })
      .catch((err) => (document.body.innerHTML = err));
  ...
  const Priority_ = (e) => {
    axios
      .get(`http://10.0.0.116:5000/PrimaryTasks/priority/${e.target.value}`)
      .then((res) => {
        setstate(res.data);
      })
      .catch((err) => (document.body.innerHTML = err));
  ...
  const TaskRecurrence_ = (e) => {
    axios
      .get(
        `http://10.0.0.116:5000/PrimaryTasks/TaskRecurrence/${e.target.value}`
      )
      .then((res) => {
        setstate(res.data);
      })
