...
export default function Admin() {
  ...
  useEffect(() => {
    axios
      .get(`http://10.0.0.116:5000/PrimaryTasks/${id}`)
      .then((res) => {
        setID(res.data.ID);
        ...
        setThudesday(res.data.Thudesday);
  ...
  const Thuesday_ = (e) => setThuesday(e.target.checked);
  const Wednesday_ = (e) => setWednesday(e.target.checked);
  const Thuresday_ = (e) => setThudesday(e.target.checked);
  ...
  const createTaskAuth = () => {
    if (!Question || !Type) {
      ...
      axios
        .post("http://10.0.0.116:5000/Priamry/createTask", {
          Task_ID: ID,
          Type: Type,
          MinValue: Min,
          MaxValue: Max,
  ...
  const delete_ = () => {
    axios
      .post(`http://10.0.0.116:5000/DeletePrimaryTask/${id}`, {
  ...
  const post = () => {
    axios
      .post(`http://10.0.0.116:5000/PrimaryTask/update/${id}`, {
        Short_description: Short_description,
        Summary: Summary,
        Priority: Priority,
  ...
  const Click_ = () => {
    axios
      .get(`http://10.0.0.116:5000/PrimaryTasks/Auth/${ID}`)
      .then((res) => {
  ...
  const Delete_Auth = (e) => {
    axios
      .get(`http://10.0.0.116:5000/DeletePrimaryTaskAuth/${e}`)
      .then((res) => {
        alert("Deleted");
        window.location.reload();
      })
  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="mx-8">
          <div className="py-5">
            <details className="group border p-3 delay-150 ">
          ...
          <div className="-mt-5">
            <details className="group border p-3">
              <summary
                ...
                <div className="">
                  <div className="inline-block min-w-full shadow-md rounded-lg overflow-hidden">
                    <table className="min-w-full leading-normal">
                      <thead>
                        <tr>
                          <th className="px-5 py-3 border-b-2   text-left text-md font-semibold text-gray-700 capitalize tracking-wider">
                            Type
                          </th>
                          <th className="px-5 py-3 border-b-2   text-left text-md font-semibold text-gray-700 capitalize tracking-wider">
                            MaxValue
                      ...
                      <tbody>
                        {TaskAuth.map((r) => (
                          <tr>
                            <td className="px-5 py-2 border-b  bg-green text-sm">
