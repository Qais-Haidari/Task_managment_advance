...
export default function Viewtask(props) {
  ...
  const Hide_ = () => {
    if (document.getElementById("Summary").classList[0] === 'hidden') {
      document.getElementById("Summary").classList[0] = '';
    } else {
      document.getElementById("Summary").classList[0] === 'hidden'
      
    }
    console.log(document.getElementById("Summary").classList[0]);
  };
              ...
              <div className="">
                ...
                <div className="inline-block min-w-full shadow-md rounded-lg overflow-hidden">
                  ...
                  <div className="m-5 flex">
                    ...
                    <div className="ml-10">
                      <h1 className="text-md text-green-600" onClick={Hide_}>
                        Summary
                      </h1>
                      <p id="Summary" className="hidden">
                        {state.Summary}
                      </p>
                    </div>
                  </div>
