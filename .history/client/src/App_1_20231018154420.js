          ...
          <div class="text-sm lg:flex-grow">
            ...
            <div className="sm:hidden lg:block">
              ...
              <Link to="/dashboard">
                <p
                  onClick={(e) => {
                    e.target.className.add('text-red-600')
                    e.target.className.remove('text-red-600')

                  }}
                  class="block mt-4 lg:inline-block lg:mt-0 active:text-red-600 text-white hover:text-white mr-4"
                >
                  Dashboard
                </p>
              </Link>
