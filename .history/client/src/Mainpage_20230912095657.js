      ...
      <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center pb-10">
          <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">
            First Name: <span>{localStorage.getItem("First_Name")}</span>
          </h5>
          <span class="lg:text-sm md:text-md text-gray-500 dark:text-gray-400">
            Last Name: <span>{localStorage.getItem("Last_Name")}</span>
          </span>
          <span class="lg:text-sm md:text-md text-gray-500 dark:text-gray-400">
          ...
          <span class="lg:text-sm md:text-md text-gray-500 dark:text-gray-400">
            Start of Business:{" "}
            <span>{localStorage.getItem("Start_of_business")}</span>
          </span>
          <span class="lg:text-sm md:text-md text-gray-500 dark:text-gray-400">
            End of Business:{" "}
            <span>{localStorage.getItem("End_of_business")}</span>
          </span>
