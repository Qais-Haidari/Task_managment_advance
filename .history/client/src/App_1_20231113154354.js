            ...
            <div className="lg:block">
              ...
              <Link to="/dashboard">
                <p
                  className={
                    state === "/dashboard"
                      ? "block mt-4 sm:hidden lg:inline-block sm:inline lg:mt-0 text-red-600  mr-4 sm:text-lg"
                      : "block mt-4 sm:hidden lg:inline-block sm:inline lg:mt-0 text-white  mr-4 sm:text-lg"
                  }
                >
                  Dashboard
                </p>
