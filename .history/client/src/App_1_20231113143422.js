        ...
        <div class="w-full block lg:flex-grow sm:flex sm:justify-between  lg:flex lg:items-center lg:w-auto">
          <div class="text-md lg:flex-grow">
            <div className="lg:block">
              <Link
                to="/tasklist"
                className={color === "/createUser" ? "w-full bg-white" : "w-full"}
                className="block mt-4 lg:inline-block active:text-red-600 sm:inline lg:mt-0 text-white hover:text-white mr-4 sm:text-lg"
              >
                My Task
              </Link>
              <Link to="/dashboard">
