...
Router.post("/createTask", async (req, res) => {
  ...
  if (req.body.OnceOFF == false) {
    ...
    for (let index = 0; index < req.body.MoreReq.length; index++) {
      Object.assign(req.body.MoreReq[index][0], { ID: uuidv4(), Task_ID: NewTask.ID } )
      .push({ ID: uuidv4(), Task_ID: NewTask.ID });
      console.log(req.body.MoreReq[index][0]);
    }
    // console.log(req.body.MoreReq);
    ...
    // });
    // await PrimaryTaskAuth.insertMany(req.body.MoreReq);
    ...
    await TaskAuth.insertMany(req.body.MoreReq);
    const TaskAuths = new TaskAuth({
      ID: uuidv4(),
      Task_ID: req.body.ID,
      Type: req.body.Type,
