...
const transporter = nodemailer.createTransport({
    ...
    text: `*Subway SA and WA will receive Statements on 21st January for Direct Debit on 26th January
            And then Subway SA and WA and Dominos /Pizza hut Fortnightly will receive Statements on22nd/23'd January instead of 29/30th for Direct Debit On Friday 2nd February as Normal
    `,
  };
