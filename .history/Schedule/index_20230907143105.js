  ...
  for (let index = 0; index < Daily_PrimaryTask.length; index++) {
    ...
    for (let index1 = 0; index1 < Daily_PrimaryTask.length; index1++) {
      ...
      await TaskAuth.create({
        ID: uuidv4(),
        Task_ID: ID,
        Type: Daily_PriamryTask_Authreq.body.Type,
        MinValue: Daily_PriamryTask_Authreq.body.MinValue,
        MaxValue: Daily_PriamryTask_Authreq.body.MaxValue,
        ExptectedValue: Daily_PriamryTask_Authreq.body.ExptectedValue,
        Questions: Daily_PriamryTask_Authreq.body.Questions,
        User: Daily_PriamryTask_AuthAssign_to_User,
        Department: Daily_PriamryTask_AuthAssign_to_Department,
        Date: Date,
